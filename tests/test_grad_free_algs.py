...
def bean_function_lite():
    ...
    return ProblemLite(x0, xl=xl, xu=xu, obj=obj, name='bean_function_lite')
...
def test_pso():
    ...
    assert optimizer.results['niter'] <= solver_options['max_itr']
...
def test_nelder_mead():
    '''
    Test the Nemder-Mead algorithm for unconstrained problems
    '''
    from numpy.testing import assert_array_equal, assert_array_almost_equal, assert_almost_equal
